<template>
        ...
        <div class="ms-login">
            ...
            <el-form :model="param" :rules="rules" ref="login" label-width="0px" class="ms-content">
                ...
                <div class="login-btn">
                    <el-button type="primary" @click="submitForm()">{{param.username=="Log in as a visitor"?param.username:"Log in"}}</el-button>
                </div>
        ...
        const login = ref(null);
            ...
            login.value.validate((valid) => {
                if (valid&&param.username=="wesley"&&param.password==123321) {
                    ...
                    ElMessage.success("Logged as visitor");
                    // router.push("/");
